...
def pipeline(pht):
    ...
    with open('Tione Patrick Gabriel Nicolas Risc Processor - PHT\programa.txt', 'r') as file:
...
print("Instruções Inválidas:", (total_instructions - executed_instructions)*2)
print("Tabela de Predição:", prediction_table)